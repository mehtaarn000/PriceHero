...
def _walmart(walmart_url):
    ...
    price = str(originalproductdata["dollars"]) + "." + str(
        originalproductdata["cents"])

    if originalproductdata["originaldollars"] == None and originalproductdata[
            "originalcents"] == None:
        productdata = {
        ...
        originalprice = str(originalproductdata["originaldollars"]) + str(
            originalproductdata["originalcents"])
        productdata = {
            "name": originalproductdata["name"],
            "price": price,
